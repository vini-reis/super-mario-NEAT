...
def getAction(a):
    """
    Function used to choose the action with the maximum score in the network.
    :param a: List of score of each possible action.
    """
    return actions_list[a.index(max(a))]
